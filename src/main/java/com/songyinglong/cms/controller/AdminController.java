...
* @version 创建时间：2019年11月13日 下午2:37:39 
* 类功能说明 
*/
@Controller
...
public class AdminController {
	...
	public String selectUsers(User user,@RequestParam(defaultValue = "1") Integer pageNum,@RequestParam(defaultValue = "3") Integer pageSize,Model model) {
	...
	public String articles(Article article,@RequestParam(defaultValue = "1") Integer pageNum,@RequestParam(defaultValue = "3") Integer pageSize,Model model) {
		//管理员查询文章默认查询待审文章
